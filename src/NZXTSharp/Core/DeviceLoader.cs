...
namespace NZXTSharp
{
    ...
    public class DeviceLoader
    {
        ...
        {
            Console.WriteLine("is already Initialized: " + _Initialized);
            if (_Initialized)
            {
                if (_ThrowExceptions)
        ...
        private static INZXTDevice[] TryGetSerialDevices(DeviceLoadFilter Filter, bool ThrowExceptions = true)
        {
            ...
            Console.WriteLine("Instantiating HuePlusController...");
            SerialController HuePlusController = new SerialController(SerialPort.GetPortNames(), HuePlusCOMData);
            Console.WriteLine("HuePlusController instantiated");
            ...
            {
                Console.WriteLine("Unexpected Thrown");
                Console.Write(e.ToString());
                throw e;
            }

            Console.WriteLine("Instantiating SerialDevices... found count: "+ DevicesFound.Count);
